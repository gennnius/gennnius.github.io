...
### [View Live gennnius world &rarr;](https://huangxuan.me)
...
```
# Site settings
title: gennnius world             # title of your website
SEOTitle: gennnius world			# check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“gennnius world”** but I want the title shows in search engine is **“黄玄的博客 | gennnius world”** which is multi-language.
...
gennnius world is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
